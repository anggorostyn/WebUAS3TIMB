...
<section className="relative min-h-screen">
  <Card
    className="bg-[#F6FFF6] dark:bg-gray-800 w-4/5 lg:w-2/3 mx-auto px-7 lg:px-24 py-9 lg:py-12 mb-8 rounded-xl shadow-xl transition-all duration-300 absolute -top-44 lg:-top-16 left-1/2 -translate-x-1/2"
  >
    <CardTitle className="uppercase font-nunito text-3xl lg:text-[40px] font-extrabold mb-4 lg:mb-8 text-center">
      Kami adalah Resikel!
    </CardTitle>
    <CardDescription className="text-lg lg:text-xl font-medium lg:mb-4 font-nunito text-center text-black dark:text-[#31A05C]">
      Mari berperan aktif menjaga kebersihan Batam! Kumpulkan dan serahkan sampah daur ulangmu ke mitra kami untuk menciptakan kota yang lebih bersih
    </CardDescription>
  </Card>

  <div className="container pt-52 sm:pt-32 lg:pt-80 lg:px-32">
    <h1 className="font-nunito text-4xl lg:text-5xl font-bold text-start">Jenis Sampah</h1>
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 lg:pt-14 lg:gap-x-14 lg:gap-y-16">
      {/* Kertas */}
      <Link
        to="/jenis-sampah/kertas"
      ...
      >
        ...
        <span className="relative z-10 font-nunito text-[29px] font-bold">Kertas</span>
      </Link>

      {/* Plastik */}
      <Link
        to="/jenis-sampah/plastik"
        className="group relative w-[258px] h-[194px] text-white flex items-center justify-center text-lg font-bold rounded-md overflow-hidden"
        style={{
      ...
      >
        <div className="absolute inset-0 bg-[#1A7F5D] opacity-40 group-hover:opacity-25 transition-all duration-300"></div>
        <span className="relative z-10 font-nunito text-[29px] font-bold">Plastik</span>
      </Link>

      {/* Aluminium */}
      <Link
        to="/jenis-sampah/aluminium"
        className="group relative w-[258px] h-[194px] text-white flex items-center justify-center text-lg font-bold rounded-md overflow-hidden"
        style={{
      ...
      >
        <div className="absolute inset-0 bg-[#1A7F5D] opacity-40 group-hover:opacity-25 transition-all duration-300"></div>
        <span className="relative z-10 font-nunito text-[29px] font-bold">Aluminium</span>
      </Link>

      {/* Besi */}
      <Link
        to="/jenis-sampah/besi"
        className="group relative w-[258px] h-[194px] text-white flex items-center justify-center text-lg font-bold rounded-md overflow-hidden"
        style={{
      ...
      >
        <div className="absolute inset-0 bg-[#1A7F5D] opacity-40 group-hover:opacity-25 transition-all duration-300"></div>
        <span className="relative z-10 font-nunito text-[29px] font-bold">Besi</span>
      </Link>

      {/* Elektronik */}
      <Link
        to="/jenis-sampah/elektronik"
        className="group relative w-[258px] h-[194px] text-white flex items-center justify-center text-lg font-bold rounded-md overflow-hidden"
        style={{
      ...
      >
        <div className="absolute inset-0 bg-[#1A7F5D] opacity-40 group-hover:opacity-25 transition-all duration-300"></div>
        <span className="relative z-10 font-nunito text-[29px] font-bold">Elektronik</span>
      </Link>

      {/* Botol Kaca */}
      <Link
        to="/jenis-sampah/kaca"
        className="group relative w-[258px] h-[194px] text-white flex items-center justify-center text-lg font-bold rounded-md overflow-hidden"
        style={{
      ...
      >
        <div className="absolute inset-0 bg-[#1A7F5D] opacity-40 group-hover:opacity-25 transition-all duration-300"></div>
        <span className="relative z-10 font-nunito text-[29px] font-bold">Kaca</span>
      </Link>

      {/* Khusus */}
      <Link
        to="/jenis-sampah/khusus"
        className="group relative w-[258px] h-[194px] text-white flex items-center justify-center text-lg font-bold rounded-md overflow-hidden"
        style={{
          backgroundImage: 'url("/images/sampahkhusus.jpg")',
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
        <div className="absolute inset-0 bg-[#1A7F5D] opacity-40 group-hover:opacity-25 transition-all duration-300"></div>
        <span className="relative z-10 font-nunito text-[29px] font-bold">Khusus</span>
      </Link>
      ...
      >
        <div className="absolute inset-0 bg-[#1A7F5D] opacity-40 group-hover:opacity-25 transition-all duration-300"></div>
        <span className="relative z-10 font-nunito text-[29px] font-bold">Tekstil</span>
      </Link>
    </div>
  </div>
</section>
