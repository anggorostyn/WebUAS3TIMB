...
//Member Team 6
import rahmanitam from "../../assets/team/rahmanitam.jpg";
import fotogoro from "../../assets/team/fotogoro.jpg";
import destian from "../../assets/team/destian.jpg";
import faisaljomlo from "../../assets/team/faisaljomblo.jpg";
import noe from "../../assets/team/noe.jpg";
import adi from "../../assets/team/adi.jpg";

function AboutPage() {
  const teamMembers = [
    { name: "Anggoro Setyo N", position: "Project Manager", photo: fotogoro},
    { name: "M Abdur Rahman", position: "Scrum Master", photo: rahmanitam},
    { name: "Desthian Chikal", position: "Scrum Master", photo:destian },
    { name: "Adi Nuzul Pratama", position: "Scrum Master",photo:adi},
    { name: "Noe Prihatoyo S", position: "Scrum Master", photo:noe },
    { name: "Faisal Hakim", position: "Scrum Master", photo: faisaljomlo },
  ];
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-[#007042] dark:text-white">
                  {member.position}
                </p>
              </div>
            </Card>
